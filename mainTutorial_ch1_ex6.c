...
int main( void )
{
    ...
    // tutorials
    xTaskCreate(vTask1, "Task 1", 200, (void *) pcTextForTask1, 1, NULL);
    xTaskCreate(vTask2, "Task 2", 200, (void *) pcTextForTask2, 1, NULL);
    xTaskCreate(vTask3, "Task 3", 200, (void *) pcTextForTask3, 2, NULL);
